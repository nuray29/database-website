...
<html lang="en">
  ...
  <body>
    <div class="container">
      <form action="curieri.php" method = "POST">
        ...
        <div class="form-group">
          <label>CNP</label>
          <input type="text" name = "CNP" class="form-control" value = "">
        </div>
        <div class="form-group">
          <label>Judet</label>
        ...
        <div class="form-group">
          ...
          <input type="text" name = "Data_Nasterii" class="form-control" value = "">
        </div>
        <div class="form-group">
          <label>Data angajarii</label>
          <input type="text" name = "Data_Angajarii" class="form-control" value = "">
        </div>
        <div class="form-group">
          <label>Salariu</label>
          <input type="text" name = "Salariu" class="form-control" value = "">
        </div>
        <div class="form-group">
